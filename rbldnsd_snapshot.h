...
int rbldnsd_snapshot_lookup(const struct dataset *, const unsigned char *, unsigned, unsigned,
                            struct snapshot_entry *);
typedef int snapshot_produce_fn(snapshot_visit_fn *, void *visit_arg, void *producer_arg);
int rbldnsd_snapshot_write_iter_ident(const struct dataset *, const char *, snapshot_produce_fn *,
                                      void *, uint64_t *dev, uint64_t *ino);
